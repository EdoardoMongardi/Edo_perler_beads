...
export async function downloadImage({
  ...
  const processDownload = () => {
    ...
    ctx.fillText('PerlerBeads', titleStartX, mainTitleY);
    ...
    ctx.fillText('Perler Beads Generator', titleStartX, subTitleY);
    ...
    const secondaryText = '@PerlerBeads';
    ...
    if (includeStats && colorCounts) {
      ...
      const statsWatermarkText = 'Made with PerlerBeads';
